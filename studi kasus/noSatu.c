...
int main() {
    ...
    do {
        ...
        printf("Masukkan kode transportasi (1: Bus, 2: Kereta Api, 3: Ferry, 4: Pesawat): ");
        scanf("%d", &data[index].kode_transportasi);
        ...
        switch (data[index].jumlah_tiket) {
            case 1:
                data[index].total_penjualan = 50000 * data[index].jumlah_tiket;
                break;
            case 2:
                data[index].total_penjualan = 100000 * data[index].jumlah_tiket;
                break;
            case 3:
                data[index].total_penjualan = 75000 * data[index].jumlah_tiket;
                break;
            case 4:
                data[index].total_penjualan = 200000 * data[index].jumlah_tiket;
                break;
            default:
        ...
        if (data[index].jumlah_tiket >= 3) {
            data[index].total_penjualan *= 0.9; // Apply 10% discount
        }
...
for (i = 0; i < jumlah_data; i++) {
    if (data[i].total_penjualan < x) {
        ...
        switch (data[i].kode_transportasi) {
            case 1:
                printf("Bus\n");
                break;
            case 2:
            ...
            case 4:
                ...
                break;
            default:
                printf("Kode transportasi tidak valid\n");
        }
